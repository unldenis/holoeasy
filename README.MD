...
> [!WARNING]
> Jitpack currently returns a 'Please Sign In first' error. You can find the build of the library  <a href="https://github.com/unldenis/holoeasy/releases/tag/3.0.0">here</a>.
